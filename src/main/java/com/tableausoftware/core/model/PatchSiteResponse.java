...
public class PatchSiteResponse {
  ...
  public PatchSiteResponse contentUrl(String contentUrl) {
  ...
  */
  ...
  public PatchSiteResponse createDateTime(OffsetDateTime createDateTime) {
  ...
  */
  ...
  public PatchSiteResponse creatorCapacity(Integer creatorCapacity) {
  ...
  */
  ...
  public PatchSiteResponse creatorCapacityIsDefaultCloudLimit(Boolean creatorCapacityIsDefaultCloudLimit) {
  ...
  */
  ...
  public PatchSiteResponse explorerCapacity(Integer explorerCapacity) {
  ...
  */
  ...
  public PatchSiteResponse explorerCapacityIsDefaultCloudLimit(Boolean explorerCapacityIsDefaultCloudLimit) {
  ...
  */
  ...
  public PatchSiteResponse instance(PodInstance instance) {
  ...
  */
  ...
  public PatchSiteResponse lastUpdateDateTime(OffsetDateTime lastUpdateDateTime) {
  ...
  */
  ...
  public PatchSiteResponse location(String location) {
  ...
  */
  ...
  public PatchSiteResponse migrationStatus(MigrationStatusEnum migrationStatus) {
  ...
  */
  ...
  public PatchSiteResponse name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public PatchSiteResponse siteUUID(UUID siteUUID) {
  ...
  */
  ...
  public PatchSiteResponse status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public PatchSiteResponse storageQuota(Long storageQuota) {
  ...
  */
  ...
  public PatchSiteResponse storageUsed(Long storageUsed) {
  ...
  */
  ...
  public PatchSiteResponse suspendedDateTime(OffsetDateTime suspendedDateTime) {
  ...
  */
  ...
  public PatchSiteResponse tenantId(UUID tenantId) {
  ...
  */
  ...
  public PatchSiteResponse viewerCapacity(Integer viewerCapacity) {
  ...
  */
  ...
  public PatchSiteResponse viewerCapacityIsDefaultCloudLimit(Boolean viewerCapacityIsDefaultCloudLimit) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    PatchSiteResponse patchSiteResponse = (PatchSiteResponse) o;
    return Objects.equals(this.contentUrl, patchSiteResponse.contentUrl) &&
        Objects.equals(this.createDateTime, patchSiteResponse.createDateTime) &&
        Objects.equals(this.creatorCapacity, patchSiteResponse.creatorCapacity) &&
        Objects.equals(this.creatorCapacityIsDefaultCloudLimit, patchSiteResponse.creatorCapacityIsDefaultCloudLimit) &&
        Objects.equals(this.explorerCapacity, patchSiteResponse.explorerCapacity) &&
        Objects.equals(this.explorerCapacityIsDefaultCloudLimit, patchSiteResponse.explorerCapacityIsDefaultCloudLimit) &&
        Objects.equals(this.instance, patchSiteResponse.instance) &&
        Objects.equals(this.lastUpdateDateTime, patchSiteResponse.lastUpdateDateTime) &&
        Objects.equals(this.location, patchSiteResponse.location) &&
        Objects.equals(this.migrationStatus, patchSiteResponse.migrationStatus) &&
        Objects.equals(this.name, patchSiteResponse.name) &&
        Objects.equals(this.siteUUID, patchSiteResponse.siteUUID) &&
        Objects.equals(this.status, patchSiteResponse.status) &&
        Objects.equals(this.storageQuota, patchSiteResponse.storageQuota) &&
        Objects.equals(this.storageUsed, patchSiteResponse.storageUsed) &&
        Objects.equals(this.suspendedDateTime, patchSiteResponse.suspendedDateTime) &&
        Objects.equals(this.tenantId, patchSiteResponse.tenantId) &&
        Objects.equals(this.viewerCapacity, patchSiteResponse.viewerCapacity) &&
        Objects.equals(this.viewerCapacityIsDefaultCloudLimit, patchSiteResponse.viewerCapacityIsDefaultCloudLimit);
  }
  ...
  public String toString() {
    ...
    sb.append("class PatchSiteResponse {\n");
