...
import com.tableausoftware.core.model.UserSiteRoleDTO;
...
public class CreateUserRequestDTO {
  ...
  @Valid
  private List<@Valid UserSiteRoleDTO> siteRoles;

  private String userName;

  /**
   * Default constructor
   * @deprecated Use {@link CreateUserRequestDTO#CreateUserRequestDTO(String)}
   */
  @Deprecated
  ...
  */
  ...
  public CreateUserRequestDTO language(LanguageEnum language) {
  ...
  */
  ...
  public CreateUserRequestDTO linkRoles(List<@Valid UserLinkRoleDTO> linkRoles) {
    this.linkRoles = linkRoles;
    return this;
  }

  public CreateUserRequestDTO addLinkRolesItem(UserLinkRoleDTO linkRolesItem) {
  ...
  */
  ...
  public CreateUserRequestDTO locale(LocaleEnum locale) {
    this.locale = locale;
    return this;
  }
  ...
  */
  ...
  public CreateUserRequestDTO siteRoles(List<@Valid UserSiteRoleDTO> siteRoles) {
    this.siteRoles = siteRoles;
    return this;
  }

  public CreateUserRequestDTO addSiteRolesItem(UserSiteRoleDTO siteRolesItem) {
  ...
  */
  @Valid 
  @Schema(name = "siteRoles", description = "Site role of the user to be created", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("siteRoles")
  public List<@Valid UserSiteRoleDTO> getSiteRoles() {
    return siteRoles;
  }

  public void setSiteRoles(List<@Valid UserSiteRoleDTO> siteRoles) {
    this.siteRoles = siteRoles;
  }

  public CreateUserRequestDTO userName(String userName) {
    this.userName = userName;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.email, createUserRequestDTO.email) &&
        Objects.equals(this.language, createUserRequestDTO.language) &&
        Objects.equals(this.linkRoles, createUserRequestDTO.linkRoles) &&
        Objects.equals(this.locale, createUserRequestDTO.locale) &&
        Objects.equals(this.siteRoles, createUserRequestDTO.siteRoles) &&
        Objects.equals(this.userName, createUserRequestDTO.userName);
  }
